#Dead$quad | AnyDesk IP Resolver
#Created By Abborniet & Loud

import subprocess, colorama, requests, base64, os

os.system('@title SkullSquad | Anydesk IP Resolver && cls')
...
print("")
print("Created By Infecting A.K.A Tu padre")
print("           #SkullSquadNeverDies")
print("")
print("")
